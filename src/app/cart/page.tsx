...
const Cartpage = () => {
  return (
    <div className='h-[calc(100vh-6rem)] flex flex-col text-red-500 lg:flex-row'>
         ...
         <div className='flex-1 p-4 bg-red-100 flex flex-col gap-4 justify-center lg:px-20'>
            ...
            <button className='bg-red-500 text-white p-3 rounded-lg w-1/2 self-end'>CHECK OUT</button>
         </div>
    </div>
  )
}
